...
// not notifier.Notifier -- gonest's resolver matches MustInject[Interface]
// against it via reflect.Type.Implements(), not an exact type match. That
// is deliberate: it lets email/sms stay leaf packages with ZERO import of
// this package, which is what avoids an import cycle (this package already
// imports email/sms to reference their Module vars; if they imported this
// package back for the interface type, that would cycle).
//
