...
func (f *ValidationExceptionFilter) Catch(err error, ctx *common.Context) error {
...
func (f *UnauthorizedExceptionFilter) Catch(err error, ctx *common.Context) error {
...
func (f *ForbiddenExceptionFilter) Catch(err error, ctx *common.Context) error {
	if httpErr, ok := err.(*HTTPException); ok {
...
func (f *NotFoundExceptionFilter) Catch(err error, ctx *common.Context) error {
	if httpErr, ok := err.(*HTTPException); ok {
...
func ChainExceptionFilters(filters ...ExceptionFilter) ExceptionFilter {
	return ExceptionFilterFunc(func(err error, ctx *common.Context) error {
