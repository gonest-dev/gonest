...
func (a *GinAdapter) RegisterRoute(route common.RouteDefinition) error {
...
func (a *GinAdapter) wrapHandler(route common.RouteDefinition) gin.HandlerFunc {
