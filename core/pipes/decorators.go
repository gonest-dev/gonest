...
func UsePipes(pipes ...any) common.MiddlewareFunc {
...
func Body[T any](validate bool) func(*common.Context) (*T, error) {
	return func(ctx *common.Context) (*T, error) {
		var dto T
...
func Param(name string, pipes ...any) func(*common.Context) (any, error) {
	return func(ctx *common.Context) (any, error) {
...
func Query(name string, pipes ...any) func(*common.Context) (any, error) {
	return func(ctx *common.Context) (any, error) {
...
func applyPipe(pipe any, value any, ctx *common.Context) (any, error) {
...
func ValidateBody[T any](ctx *common.Context) (*T, error) {
	var dto T
