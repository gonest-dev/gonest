...
// declared in schema.go). ONE type serves all 4 branches because they
...
//
// NumericSchema embeds *PropertyBuilder (a POINTER, the exact same object
...
// made through a NumericSchema value mutate the SAME underlying builder a
// future consumer (Schema.OwnProperties()) will see. This is the exact
// same reasoning StringSchema's own doc comment already spells out --
...
// through the embedded field, for the identical reason StringSchema's own
...
// can chain.
func (n *NumericSchema) Min(v int) *NumericSchema {
	n.min = &v
	return n
}
...
func (n *NumericSchema) MinValue() (int, bool) {
	if n.min == nil {
		return 0, false
	}
	return *n.min, true
...
// can chain.
func (n *NumericSchema) Max(v int) *NumericSchema {
	n.max = &v
	return n
}
...
func (n *NumericSchema) MaxValue() (int, bool) {
	if n.max == nil {
		return 0, false
	}
	return *n.max, true
...
func (n *NumericSchema) Required() *NumericSchema {
...
func (n *NumericSchema) Nullable() *NumericSchema {
...
// (mutating the SHARED object), then returns n. See Required's doc comment
// for why this manual re-declaration exists.
func (n *NumericSchema) Examples(examples ...any) *NumericSchema {
