...
// call shape).
//
// This package only builds the in-memory *OpenAPI -- serving it
...
// New constructs a zero-value *OpenAPI, stores specVersion, runs fn
...
func New(specVersion string, fn func(b *OpenAPI)) *OpenAPI {
	b := &OpenAPI{specVersion: specVersion}
	if fn != nil {
		fn(b)
	}
	return b
...
func (b *OpenAPI) SpecVersion() string {
...
func (b *OpenAPI) Title(s string) *OpenAPI {
	b.title = s
	return b
}
...
func (b *OpenAPI) TitleText() string {
	return b.title
}
...
// was never called.
func (b *OpenAPI) DescriptionText() string {
...
func (b *OpenAPI) Version(s string) *OpenAPI {
	b.version = s
	return b
}
...
// called.
func (b *OpenAPI) VersionText() string {
	return b.version
}
...
// together.
func (b *OpenAPI) Contact(name, url, email string) *OpenAPI {
	b.contactName = name
	b.contactUrl = url
...
// never called.
func (b *OpenAPI) ContactInfo() (name, url, email string) {
...
func (b *OpenAPI) License(name, url string) *OpenAPI {
	b.licenseName = name
	b.licenseUrl = url
	return b
}
...
// called.
func (b *OpenAPI) LicenseInfo() (name, url string) {
...
// OD-05.
func (b *OpenAPI) BearerAuth() *OpenAPI {
	b.bearerAuth = true
	return b
}
...
func (b *OpenAPI) HasBearerAuth() bool {
	return b.bearerAuth
}
