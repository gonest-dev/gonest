...
type HttpAdapter interface {
	...
	// RegisterWebSocket wires one WebSocket upgrade endpoint onto the real
	// underlying HTTP engine (graphql-support feature, Milestone 17's
	// WebSocket Subscription transport, T10) -- a genuinely different
	// connection shape than RegisterRoute's execution.Request/Response
