...
func WithSwagger(summary, description string) func(*common.RouteDefinition) {
	return func(route *common.RouteDefinition) {
...
func WithTags(tags ...string) func(*common.RouteDefinition) {
	return func(route *common.RouteDefinition) {
		if route.Metadata == nil {
			route.Metadata = make(map[string]any)
		}
...
func WithOperationID(id string) func(*common.RouteDefinition) {
	return func(route *common.RouteDefinition) {
		if route.Metadata == nil {
			route.Metadata = make(map[string]any)
		}
...
func WithRequestBody(description string, schema *Schema) func(*common.RouteDefinition) {
	return func(route *common.RouteDefinition) {
		if route.Metadata == nil {
			route.Metadata = make(map[string]any)
		}
...
func WithResponse(statusCode, description string, schema *Schema) func(*common.RouteDefinition) {
	return func(route *common.RouteDefinition) {
		if route.Metadata == nil {
			route.Metadata = make(map[string]any)
		}
...
func WithSecurity(name string, scopes ...string) func(*common.RouteDefinition) {
	return func(route *common.RouteDefinition) {
		if route.Metadata == nil {
			route.Metadata = make(map[string]any)
		}
...
func ApplySwaggerMetadata(route *common.RouteDefinition, opts ...func(*common.RouteDefinition)) {
