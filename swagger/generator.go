...
func GenerateFromApplication(app *core.NestApplication, opts ...DocumentOption) *OpenAPIDocument {
...
func GenerateFromRoutes(routes []core.RouteDefinition, opts ...DocumentOption) *OpenAPIDocument {
	builder := NewDocumentBuilder()
...
func routeToOperation(route core.RouteDefinition) *Operation {
	operation := &Operation{
